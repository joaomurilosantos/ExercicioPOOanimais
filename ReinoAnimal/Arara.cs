...
namespace ReinoAnimal
{
    ...
    {
        public Arara(string nome, DateTime datadenascimento, char sexo, int idade, bool peconhento, bool carnivoro, bool rapina, string corpena, double velocidadedevoo, int altitudemaximaemmetros) : base(nome, datadenascimento, sexo, idade, peconhento, carnivoro, rapina, corpena)
        {
